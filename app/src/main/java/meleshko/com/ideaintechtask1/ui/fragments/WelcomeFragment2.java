...
public class WelcomeFragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mImageView.setImageResource(R.drawable.onboarding_illustration_2);
        largeText.setText(getString(R.string.welcome_large_2));
        smallText.setText(getString(R.string.welcome_small_2));
        circle_1.setImageResource(R.drawable.ic_pagination);
        circle_2.setImageResource(R.drawable.ic_pagination_active);
        circle_3.setImageResource(R.drawable.ic_pagination);
